...
def analyze(
    ...
    data = pd.DataFrame(index=["20-21","21-22","22-23","23-24","24-25"], data={
        ...
        "Total": [
            ...
            excludingBotsAndWebs[(excludingBotsAndWebs['COMMIT_DATE'] >= '2023-04-28') & (excludingBotsAndWebs['COMMIT_DATE'] < '2024-04-28')].shape[0],
            excludingBotsAndWebs[(excludingBotsAndWebs['COMMIT_DATE'] >= '2024-04-28')].shape[0]
        ]
    })
    print(tabulate(data, headers=data.columns, tablefmt="pretty"))
